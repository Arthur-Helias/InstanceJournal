...
SFK.MinLevel = 20
SFK.MaxLevel = 28
SFK.Entrances = {[1] = {MapContinentId = IMI.EasternKingdoms, MapZoneId = IZI.SilverpineForest, MapCoordinateX = 42.8, MapCoordinateY = 67.5}}
SFK.Bosses = {
    [1] = { -- NOTE: Missing abilities
        ...
        MapCoordinateY = 77.0,
        MapIsBelow = true,
        Loot = {[1] = {IJDB.I[80713], DropChance = 35}, [2] = {IJDB.I[80714], DropChance = 35}}
    },
    [2] = { -- NOTE: Missing abilities
        ...
        MapCoordinateX = 45.7,
        MapCoordinateY = 58.0,
        Loot = {[1] = {IJDB.I[1292], DropChance = 33}, [2] = {IJDB.I[6226], DropChance = 33}, [3] = {IJDB.I[6633], DropChance = 33}}
    },
    [3] = { -- NOTE: Missing abilities
        ...
        MapCoordinateX = 37.2,
        MapCoordinateY = 81.6,
        Loot = {[1] = {IJDB.I[6321], DropChance = 50}, [2] = {IJDB.I[6323], DropChance = 50}, [3] = {IJDB.I[80715], DropChance = 35}}
    },
    [4] = { -- NOTE: Missing abilities
        ...
        MapCoordinateX = 12.1,
        MapCoordinateY = 64.7,
        Loot = {[1] = {IJDB.I[55382], DropChance = 25}, [2] = {IJDB.I[55383], DropChance = 25}, [3] = {IJDB.I[55384], DropChance = 25}, [4] = {IJDB.I[55385], DropChance = 25}}
    },
    [5] = { -- NOTE: Missing abilities
        ...
        MapCoordinateX = 47.0,
        MapCoordinateY = 66.1,
        Loot = {[1] = {IJDB.I[3191], DropChance = 50}, [2] = {IJDB.I[6320], DropChance = 50}, [3] = {IJDB.I[80717], DropChance = 35}}
    },
    [6] = { -- NOTE: Missing abilities
        ...
        MapCoordinateX = 76.6,
        MapCoordinateY = 70.9,
        Loot = {[1] = {IJDB.I[6318], DropChance = 50}, [2] = {IJDB.I[6319], DropChance = 50}}
    },
    [7] = { -- NOTE: Missing abilities
        ...
        MapCoordinateY = 51.0,
        IsRare = true,
        Loot = {[1] = {IJDB.I[6641], DropChance = 50}, [2] = {IJDB.I[6642], DropChance = 50}}
    },
    [8] = { -- NOTE: Missing abilities
        ...
        MapCoordinateY = 34.3,
        MapIsBelow = true,
        Loot = {[1] = {IJDB.I[3230], DropChance = 50}, [2] = {IJDB.I[6340], DropChance = 50}}
    },
    [9] = { -- NOTE: Missing abilities
        ...
        MapCoordinateX = 70.5,
        MapCoordinateY = 28.9,
        Loot = {[1] = {IJDB.I[80716], DropChance = 25}, [2] = {IJDB.I[6314], DropChance = 25}, [3] = {IJDB.I[3748], DropChance = 50}}
    },
    [10] = { -- NOTE: Missing abilities
        ...
        MapCoordinateX = 73.8,
        MapCoordinateY = 6.9,
        Loot = {[1] = {IJDB.I[6220], DropChance = 33}, [2] = {IJDB.I[6324], DropChance = 33}, [3] = {IJDB.I[6392], DropChance = 33}, [4] = {IJDB.I[51217], DropChance = 1}}
    }
}
SFK.Quests = {IJDB.Q[1098], IJDB.Q[1013], IJDB.Q[1014], IJDB.Q[1654], IJDB.Q[1740], IJDB.Q[60108], IJDB.Q[60109], IJDB.Q[40281], IJDB.Q[41366], IJDB.Q[41378], IJDB.Q[41381]}
