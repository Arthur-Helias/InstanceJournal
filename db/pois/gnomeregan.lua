...
GNOMEREGAN.Entrances = {[1] = {MapContinentId = IMI.EasternKingdoms, MapZoneId = IZI.DunMorogh, MapCoordinateX = 24.4, MapCoordinateY = 39.6, Type = IJLib.EntranceIconType.Left}}
